    ...
    start_messages = [
        {
            ...
            'text': 'Привет, я - телеграм-бот для студентов техноложки, и я очень рад видеть тебя здесь!\n'
                    'К сожалению сейчас я заморожен — в последний раз расписание здесь обновлялось в 2018 году. '
                    'Меня разработал @b0g3r, но сейчас он не учится в Техноложке и у него не хватает свободного '
                    'времени, чтобы поддерживать меня в актуальном состоянии. \n'
                    'По секрету скажу, что он всё ещё надеется возвродить этого бота: удобные уведомления, '
                    'офигенный вид расписаний, ботом хочется пользоваться! '
                    'Дима ищет человека или небольшую команду разработчиков, которая поможет с разработкой интерфейса '
                    'для ввода расписаний, а также допилит полуавтоматический парсер. Пиши @b0g3r, если знаешь такого '
                    'человека или хочешь научиться чему-нибудь новому. \n'
                    'Всем первакам первый привет!\n'
...
class Menu(_State):
    start_messages = [
        {
            'type': 'text',
            'text': 'К сожалению сейчас я заморожен — в последний раз расписание здесь обновлялось в 2018 году. '
                    'Меня разработал @b0g3r, но сейчас он не учится в Техноложке и у него не хватает свободного '
                    'времени, чтобы поддерживать меня в актуальном состоянии. \n'
                    'По секрету скажу, что он всё ещё надеется возвродить этого бота: удобные уведомления, '
                    'офигенный вид расписаний, ботом хочется пользоваться! '
